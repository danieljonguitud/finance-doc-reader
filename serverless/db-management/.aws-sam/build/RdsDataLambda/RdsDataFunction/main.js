...
var require_dist_cjs3 = __commonJS({
  "../node_modules/@aws-sdk/middleware-host-header/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_protocol_http16 = require_dist_cjs2();
    function resolveHostHeaderConfig3(input) {
      return input;
    }
    __name(resolveHostHeaderConfig3, "resolveHostHeaderConfig");
    var hostHeaderMiddleware = /* @__PURE__ */ __name((options) => (next) => async (args) => {
      if (!import_protocol_http16.HttpRequest.isInstance(args.request)) return next(args);
      const { request } = args;
...
var require_dist_cjs5 = __commonJS({
  "../node_modules/@aws-sdk/middleware-recursion-detection/dist-cjs/index.js"(exports2, module2) {
    ...
    var recursionDetectionMiddleware = /* @__PURE__ */ __name((options) => (next) => async (args) => {
      const { request } = args;
      if (!import_protocol_http16.HttpRequest.isInstance(request) || options.runtime !== "node") {
        return next(args);
      }
    ...
    var deserializerMiddleware = /* @__PURE__ */ __name((options, deserializer) => (next, context) => async (args) => {
      ...
      try {
        ...
        if (!("$metadata" in error2)) {
          ...
          try {
            if (import_protocol_http16.HttpResponse.isInstance(response)) {
      ...
      async handle(request, { abortSignal, requestTimeout } = {}) {
        ...
        return new Promise((_resolve, _reject) => {
          ...
          const req = requestFunc(nodeHttpsOptions, (res) => {
            const httpResponse = new import_protocol_http16.HttpResponse({
...
var require_dist_cjs15 = __commonJS({
  "../node_modules/@smithy/fetch-http-handler/dist-cjs/index.js"(exports2, module2) {
          ...
          fetch(fetchRequest).then((response) => {
            ...
            if (!hasReadableStream) {
              return response.blob().then((body2) => ({
                response: new import_protocol_http16.HttpResponse({
    ...
    var import_util_base649 = require_dist_cjs11();
    ...
    async function collectBlob(blob) {
      ...
      const arrayBuffer = (0, import_util_base649.fromBase64)(base64);
...
var require_dist_cjs17 = __commonJS({
  "../node_modules/@smithy/util-stream/dist-cjs/index.js"(exports2, module2) {
    ...
    function transformToString(payload2, encoding = "utf-8") {
      if (encoding === "base64") {
        return (0, import_util_base649.toBase64)(payload2);
      }
    ...
    function transformFromString(str, encoding) {
      if (encoding === "base64") {
        return Uint8ArrayBlobAdapter2.mutate((0, import_util_base649.fromBase64)(str));
      }
  ...
  "../node_modules/@smithy/core/dist-es/submodules/schema/schemas/MapSchema.js"() {
    ...
    MapSchema = class _MapSchema extends Schema {
      ...
      static [Symbol.hasInstance](lhs) {
        ...
        if (!isPrototype && typeof lhs === "object" && lhs !== null) {
          const map3 = lhs;
          return map3.symbol === _MapSchema.symbol;
        }
        return isPrototype;
      }
    };
...
var init_HttpBindingProtocol = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/protocols/HttpBindingProtocol.js"() {
    ...
    HttpBindingProtocol = class extends HttpProtocol {
      ...
      serializeQuery(ns, data2, query2) {
        const serializer = this.serializer;
      ...
      const whatwgURL = (() => {
        try {
          ...
          if (typeof value === "object" && "hostname" in value) {
            ...
            url.search = Object.entries(query2).map(([k3, v6]) => `${k3}=${v6}`).join("&");
            return url;
          }
...
var require_dist_cjs21 = __commonJS({
  "../node_modules/@aws-sdk/util-endpoints/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_url_parser3 = require_dist_cjs20();
...
var require_dist_cjs23 = __commonJS({
  "../node_modules/@smithy/signature-v4/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_util_utf852 = require_dist_cjs10();
    ...
    var moveHeadersToQuery = /* @__PURE__ */ __name((request, options = {}) => {
      const { headers, query: query2 = {} } = import_protocol_http16.HttpRequest.clone(request);
      for (const name of Object.keys(headers)) {
    ...
    var prepareRequest = /* @__PURE__ */ __name((request) => {
      request = import_protocol_http16.HttpRequest.clone(request);
    ...
    var import_util_middleware8 = require_dist_cjs6();
...
var require_dist_cjs24 = __commonJS({
  "../node_modules/@smithy/util-body-length-browser/dist-cjs/index.js"(exports2, module2) {
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
    var __hasOwnProp2 = Object.prototype.hasOwnProperty;
    ...
    var src_exports = {};
    __export2(src_exports, {
      calculateBodyLength: () => calculateBodyLength5
    });
    module2.exports = __toCommonJS2(src_exports);
    var TEXT_ENCODER = typeof TextEncoder == "function" ? new TextEncoder() : null;
    var calculateBodyLength5 = /* @__PURE__ */ __name((body) => {
...
var import_protocol_http12, import_util_body_length_browser, dateToTag, loadSmithyRpcV2CborErrorCode;
var init_parseCborBody = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/cbor/parseCborBody.js"() {
    import_protocol_http12 = __toESM(require_dist_cjs2());
    import_util_body_length_browser = __toESM(require_dist_cjs24());
    init_cbor_types();
    dateToTag = (date) => {
      return tag({
        tag: 1,
...
var import_util_body_length_browser2, ProtocolLib;
var init_ProtocolLib = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/protocols/ProtocolLib.js"() {
    init_schema();
    import_util_body_length_browser2 = __toESM(require_dist_cjs24());
    ProtocolLib = class {
      calculateContentLength(body, serdeContext) {
        const bodyLengthCalculator = serdeContext?.bodyLengthChecker ?? import_util_body_length_browser2.calculateBodyLength;
...
var require_dist_cjs26 = __commonJS({
  "../node_modules/@smithy/smithy-client/dist-cjs/index.js"(exports2, module2) {
    ...
    __export2(src_exports, {
      ...
      _json: () => _json2,
      collectBody: () => import_protocols9.collectBody,
      ...
      map: () => map3,
      resolveDefaultRuntimeConfig: () => resolveDefaultRuntimeConfig3,
      resolvedPath: () => import_protocols9.resolvedPath,
    ...
    var import_protocols9 = (init_protocols(), __toCommonJS(protocols_exports));
    var import_types5 = require_dist_cjs();
...
function hasSeq(data2, seq, i3) {
  for (let j3 = 0; j3 < seq.length; j3++) {
    if (seq[j3] !== data2[i3 + j3 + 1]) return false;
  }
  return true;
}
...
var import_smithy_client4, import_util_base645, QueryShapeSerializer;
      ...
      write(schema, value, prefix = "") {
        ...
        if (ns.isBlobSchema()) {
          if (typeof value === "string" || value instanceof Uint8Array) {
            ...
            this.writeValue((this.serdeContext?.base64Encoder ?? import_util_base645.toBase64)(value));
          }
...
var import_xml_builder, import_smithy_client6, import_util_base646, XmlShapeSerializer;
    ...
    XmlShapeSerializer = class extends SerdeContextConfig {
      ...
      write(schema, value) {
        ...
        if (ns.isStringSchema() && typeof value === "string") {
          ...
          this.byteBuffer = "byteLength" in value ? value : (this.serdeContext?.base64Decoder ?? import_util_base646.fromBase64)(value);
        } else {
      ...
      writeSimple(_schema, value) {
        ...
        if (value && typeof value === "object") {
          if (ns.isBlobSchema()) {
            nodeContents = (this.serdeContext?.base64Encoder ?? import_util_base646.toBase64)(value);
...
var require_dist_cjs28 = __commonJS({
  "../node_modules/@aws-sdk/middleware-user-agent/dist-cjs/index.js"(exports2, module2) {
    ...
    var userAgentMiddleware = /* @__PURE__ */ __name((options) => (next, context) => async (args) => {
      const { request } = args;
      if (!import_protocol_http16.HttpRequest.isInstance(request)) {
        return next(args);
      }
...
var require_dist_cjs30 = __commonJS({
  "../node_modules/@smithy/config-resolver/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_util_config_provider = require_dist_cjs29();
    ...
    var resolveCustomEndpointsConfig = /* @__PURE__ */ __name((input) => {
      ...
      return Object.assign(input, {
        tls: tls ?? true,
        endpoint: (0, import_util_middleware8.normalizeProvider)(typeof endpoint === "string" ? urlParser(endpoint) : endpoint),
        isCustomEndpoint: true,
        useDualstackEndpoint: (0, import_util_middleware8.normalizeProvider)(useDualstackEndpoint ?? false)
      });
    ...
    var resolveEndpointsConfig = /* @__PURE__ */ __name((input) => {
      const useDualstackEndpoint = (0, import_util_middleware8.normalizeProvider)(input.useDualstackEndpoint ?? false);
      const { endpoint, useFipsEndpoint, urlParser, tls } = input;
      return Object.assign(input, {
        tls: tls ?? true,
        endpoint: endpoint ? (0, import_util_middleware8.normalizeProvider)(typeof endpoint === "string" ? urlParser(endpoint) : endpoint) : () => getEndpointFromRegion({ ...input, useDualstackEndpoint, useFipsEndpoint }),
...
var require_dist_cjs32 = __commonJS({
  "../node_modules/@smithy/shared-ini-file-loader/dist-cjs/index.js"(exports2, module2) {
    ...
    var getSsoSessionData = /* @__PURE__ */ __name((data2) => Object.entries(data2).filter(([key]) => key.startsWith(import_types5.IniSectionType.SSO_SESSION + CONFIG_PREFIX_SEPARATOR)).reduce((acc, [key, value]) => ({ ...acc, [key.substring(key.indexOf(CONFIG_PREFIX_SEPARATOR) + 1)]: value }), {}), "getSsoSessionData");
...
var require_dist_cjs34 = __commonJS({
  "../node_modules/@smithy/middleware-endpoint/dist-cjs/index.js"(exports2, module2) {
    ...
    var endpointMiddleware = /* @__PURE__ */ __name(({
      ...
      return (next, context) => async (args) => {
        ...
        if (authScheme) {
          ...
          const smithyContext = (0, import_util_middleware8.getSmithyContext)(context);
    ...
    var resolveEndpointConfig3 = /* @__PURE__ */ __name((input) => {
      ...
      const customEndpointProvider = endpoint != null ? async () => toEndpointV1(await (0, import_util_middleware8.normalizeProvider)(endpoint)()) : void 0;
      ...
      const resolvedConfig = Object.assign(input, {
        ...
        isCustomEndpoint,
        useDualstackEndpoint: (0, import_util_middleware8.normalizeProvider)(useDualstackEndpoint ?? false),
        useFipsEndpoint: (0, import_util_middleware8.normalizeProvider)(useFipsEndpoint ?? false)
      });
...
var require_dist_cjs37 = __commonJS({
  "../node_modules/@smithy/middleware-retry/dist-cjs/index.js"(exports2, module2) {
    ...
    var resolveRetryConfig3 = /* @__PURE__ */ __name((input) => {
      ...
      const maxAttempts = (0, import_util_middleware8.normalizeProvider)(_maxAttempts ?? import_util_retry3.DEFAULT_MAX_ATTEMPTS);
      return Object.assign(input, {
        maxAttempts,
        retryStrategy: async () => {
          if (retryStrategy) {
          ...
          const retryMode = await (0, import_util_middleware8.normalizeProvider)(_retryMode)();
    ...
    var retryMiddleware = /* @__PURE__ */ __name((options) => (next, context) => async (args) => {
      ...
      if (isRetryStrategyV2(retryStrategy)) {
        ...
        const { request } = args;
        const isRequest = import_protocol_http16.HttpRequest.isInstance(request);
        if (isRequest) {
          request.headers[import_util_retry3.INVOCATION_ID_HEADER] = (0, import_uuid2.v4)();
        }
        while (true) {
...
var require_httpAuthSchemeProvider = __commonJS({
  "../node_modules/@aws-sdk/client-rds-data/dist-cjs/auth/httpAuthSchemeProvider.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_package = __commonJS({
  "../node_modules/@aws-sdk/client-rds-data/package.json"(exports2, module2) {
    module2.exports = {
...
var require_dist_cjs39 = __commonJS({
  "../node_modules/@smithy/credential-provider-imds/dist-cjs/index.js"(exports2, module2) {
    ...
    var import_node_config_provider3 = require_dist_cjs33();
    var import_url_parser3 = require_dist_cjs20();
  ...
  "../node_modules/@aws-sdk/client-sso/dist-cjs/index.js"(exports2, module2) {
    ...
    var resolveRuntimeExtensions3 = /* @__PURE__ */ __name((runtimeConfig, extensions) => {
      const extensionConfiguration = Object.assign(
        ...
        (0, import_protocol_http16.getHttpHandlerExtensionConfiguration)(runtimeConfig),
    ...
    var _a2;
    var SSOClient = (_a2 = class extends import_smithy_client28.Client {
    ...
    var import_middleware_serde5 = require_dist_cjs7();
    var _a3;
    var SSOServiceException = (_a3 = class extends import_smithy_client28.ServiceException {
      /**
       * @internal
       */
      constructor(options) {
    ...
    var se_GetRoleCredentialsCommand = /* @__PURE__ */ __name(async (input, context) => {
      ...
      const query2 = (0, import_smithy_client28.map)({
    ...
    var _a8;
    var GetRoleCredentialsCommand = (_a8 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
    ...
    var _a9;
    var ListAccountRolesCommand = (_a9 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        (0, import_middleware_serde5.getSerdePlugin)(config, this.serialize, this.deserialize),
        (0, import_middleware_endpoint6.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var _a10;
    var ListAccountsCommand = (_a10 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        (0, import_middleware_serde5.getSerdePlugin)(config, this.serialize, this.deserialize),
        (0, import_middleware_endpoint6.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var _a11;
    var LogoutCommand = (_a11 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        (0, import_middleware_serde5.getSerdePlugin)(config, this.serialize, this.deserialize),
        (0, import_middleware_endpoint6.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
      ];
...
var import_smithy_client7, import_url_parser, import_util_base647, import_util_utf88, getRuntimeConfig;
...
var import_region_config_resolver, import_protocol_http13, import_smithy_client10, resolveRuntimeExtensions;
...
var import_smithy_client17, import_url_parser2, import_util_base648, import_util_utf89, getRuntimeConfig3;
...
var import_region_config_resolver2, import_protocol_http14, import_smithy_client20, resolveRuntimeExtensions2;
var init_runtimeExtensions2 = __esm({
  "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/runtimeExtensions.js"() {
    ...
    resolveRuntimeExtensions2 = (runtimeConfig, extensions) => {
      const extensionConfiguration = Object.assign((0, import_region_config_resolver2.getAwsRegionExtensionConfiguration)(runtimeConfig), (0, import_smithy_client20.getDefaultExtensionConfiguration)(runtimeConfig), (0, import_protocol_http14.getHttpHandlerExtensionConfiguration)(runtimeConfig), getHttpAuthExtensionConfiguration2(runtimeConfig));
      extensions.forEach((extension) => extension.configure(extensionConfiguration));
      return Object.assign(runtimeConfig, (0, import_region_config_resolver2.resolveAwsRegionExtensionConfiguration)(extensionConfiguration), (0, import_smithy_client20.resolveDefaultRuntimeConfig)(extensionConfiguration), (0, import_protocol_http14.resolveHttpHandlerRuntimeConfig)(extensionConfiguration), resolveHttpAuthRuntimeConfig2(extensionConfiguration));
    };
  }
});
...
var require_ruleset2 = __commonJS({
  "../node_modules/@aws-sdk/client-rds-data/dist-cjs/endpoint/ruleset.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.ruleSet = void 0;
    var s3 = "required";
    ...
    var q3 = [l3];
    var r3 = [{ [v6]: "Region" }];
    var _data3 = { version: "1.0", parameters: { Region: h3, UseDualStack: i3, UseFIPS: i3, Endpoint: h3 }, rules: [{ conditions: [{ [t3]: b3, [u3]: [j3] }], rules: [{ conditions: p3, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d3 }, { conditions: q3, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d3 }, { endpoint: { url: j3, properties: m3, headers: m3 }, type: e3 }], type: f3 }, { conditions: [{ [t3]: b3, [u3]: r3 }], rules: [{ conditions: [{ [t3]: "aws.partition", [u3]: r3, assign: g3 }], rules: [{ conditions: [k3, l3], rules: [{ conditions: [{ [t3]: c3, [u3]: [a3, n3] }, o3], rules: [{ endpoint: { url: "https://rds-data-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m3, headers: m3 }, type: e3 }], type: f3 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d3 }], type: f3 }, { conditions: p3, rules: [{ conditions: [{ [t3]: c3, [u3]: [n3, a3] }], rules: [{ endpoint: { url: "https://rds-data-fips.{Region}.{PartitionResult#dnsSuffix}", properties: m3, headers: m3 }, type: e3 }], type: f3 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d3 }], type: f3 }, { conditions: q3, rules: [{ conditions: [o3], rules: [{ endpoint: { url: "https://rds-data.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m3, headers: m3 }, type: e3 }], type: f3 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d3 }], type: f3 }, { endpoint: { url: "https://rds-data.{Region}.{PartitionResult#dnsSuffix}", properties: m3, headers: m3 }, type: e3 }], type: f3 }], type: f3 }, { error: "Invalid Configuration: Missing Region", type: d3 }] };
    exports2.ruleSet = _data3;
  }
});
...
var require_endpointResolver2 = __commonJS({
  "../node_modules/@aws-sdk/client-rds-data/dist-cjs/endpoint/endpointResolver.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.defaultEndpointResolver = void 0;
    var util_endpoints_1 = require_dist_cjs21();
...
var require_runtimeConfig_shared2 = __commonJS({
  "../node_modules/@aws-sdk/client-rds-data/dist-cjs/runtimeConfig.shared.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getRuntimeConfig = void 0;
    var core_1 = (init_dist_es2(), __toCommonJS(dist_es_exports2));
...
var require_runtimeConfig2 = __commonJS({
  "../node_modules/@aws-sdk/client-rds-data/dist-cjs/runtimeConfig.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getRuntimeConfig = void 0;
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
...
var require_dist_cjs53 = __commonJS({
  "../node_modules/@aws-sdk/client-rds-data/dist-cjs/index.js"(exports2, module2) {
    "use strict";
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
    ...
    var _a2;
    var RDSDataClient2 = (_a2 = class extends import_smithy_client28.Client {
      constructor(...[configuration]) {
        const _config_0 = (0, import_runtimeConfig5.getRuntimeConfig)(configuration || {});
        super(_config_0);
        /**
    ...
    var import_core22 = (init_dist_es2(), __toCommonJS(dist_es_exports2));
    var _a3;
    var RDSDataServiceException = (_a3 = class extends import_smithy_client28.ServiceException {
      /**
       * @internal
       */
      constructor(options) {
    ...
    var se_BatchExecuteStatementCommand = /* @__PURE__ */ __name(async (input, context) => {
      ...
      body = JSON.stringify(
        (0, import_smithy_client28.take)(input, {
          database: [],
          parameterSets: /* @__PURE__ */ __name((_2) => se_SqlParameterSets(_2, context), "parameterSets"),
          resourceArn: [],
          schema: [],
          secretArn: [],
          sql: [],
    ...
    var se_ExecuteStatementCommand = /* @__PURE__ */ __name(async (input, context) => {
      ...
      body = JSON.stringify(
        (0, import_smithy_client28.take)(input, {
          ...
          parameters: /* @__PURE__ */ __name((_2) => se_SqlParametersList(_2, context), "parameters"),
          resourceArn: [],
          resultSetOptions: /* @__PURE__ */ __name((_2) => (0, import_smithy_client28._json)(_2), "resultSetOptions"),
          schema: [],
          secretArn: [],
          sql: [],
          transactionId: []
    ...
    var de_BatchExecuteStatementCommand = /* @__PURE__ */ __name(async (output, context) => {
      ...
      const data2 = (0, import_smithy_client28.expectNonNull)((0, import_smithy_client28.expectObject)(await (0, import_core22.parseJsonBody)(output.body, context)), "body");
      const doc = (0, import_smithy_client28.take)(data2, {
        updateResults: /* @__PURE__ */ __name((_2) => de_UpdateResults(_2, context), "updateResults")
      });
      Object.assign(contents, doc);
      return contents;
    ...
    var de_BeginTransactionCommand = /* @__PURE__ */ __name(async (output, context) => {
      ...
      const data2 = (0, import_smithy_client28.expectNonNull)((0, import_smithy_client28.expectObject)(await (0, import_core22.parseJsonBody)(output.body, context)), "body");
      const doc = (0, import_smithy_client28.take)(data2, {
        transactionId: import_smithy_client28.expectString
      });
      Object.assign(contents, doc);
      return contents;
    ...
    var de_CommitTransactionCommand = /* @__PURE__ */ __name(async (output, context) => {
      ...
      const data2 = (0, import_smithy_client28.expectNonNull)((0, import_smithy_client28.expectObject)(await (0, import_core22.parseJsonBody)(output.body, context)), "body");
      const doc = (0, import_smithy_client28.take)(data2, {
        transactionStatus: import_smithy_client28.expectString
      });
      Object.assign(contents, doc);
      return contents;
    ...
    var de_ExecuteSqlCommand = /* @__PURE__ */ __name(async (output, context) => {
      ...
      const data2 = (0, import_smithy_client28.expectNonNull)((0, import_smithy_client28.expectObject)(await (0, import_core22.parseJsonBody)(output.body, context)), "body");
      const doc = (0, import_smithy_client28.take)(data2, {
        sqlStatementResults: /* @__PURE__ */ __name((_2) => de_SqlStatementResults(_2, context), "sqlStatementResults")
      });
      Object.assign(contents, doc);
      return contents;
    ...
    var de_ExecuteStatementCommand = /* @__PURE__ */ __name(async (output, context) => {
      ...
      const data2 = (0, import_smithy_client28.expectNonNull)((0, import_smithy_client28.expectObject)(await (0, import_core22.parseJsonBody)(output.body, context)), "body");
      const doc = (0, import_smithy_client28.take)(data2, {
        columnMetadata: import_smithy_client28._json,
        formattedRecords: import_smithy_client28.expectString,
        generatedFields: /* @__PURE__ */ __name((_2) => de_FieldList(_2, context), "generatedFields"),
        numberOfRecordsUpdated: import_smithy_client28.expectLong,
        records: /* @__PURE__ */ __name((_2) => de_SqlRecords(_2, context), "records")
      });
      Object.assign(contents, doc);
      return contents;
    ...
    var throwDefaultError3 = (0, import_smithy_client28.withBaseException)(RDSDataServiceException);
    ...
    var de_StatementTimeoutExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
      ...
      const data2 = parsedOutput.body;
      const doc = (0, import_smithy_client28.take)(data2, {
        dbConnectionId: import_smithy_client28.expectLong,
        message: import_smithy_client28.expectString
      });
      Object.assign(contents, doc);
    ...
    var se_ArrayValue = /* @__PURE__ */ __name((input, context) => {
      return ArrayValue.visit(input, {
        ...
        booleanValues: /* @__PURE__ */ __name((value) => ({ booleanValues: (0, import_smithy_client28._json)(value) }), "booleanValues"),
        doubleValues: /* @__PURE__ */ __name((value) => ({ doubleValues: se_DoubleArray(value, context) }), "doubleValues"),
        longValues: /* @__PURE__ */ __name((value) => ({ longValues: (0, import_smithy_client28._json)(value) }), "longValues"),
        stringValues: /* @__PURE__ */ __name((value) => ({ stringValues: (0, import_smithy_client28._json)(value) }), "stringValues"),
        _: /* @__PURE__ */ __name((name, value) => ({ [name]: value }), "_")
      });
    }, "se_ArrayValue");
    var se_DoubleArray = /* @__PURE__ */ __name((input, context) => {
      return input.filter((e3) => e3 != null).map((entry) => {
        return (0, import_smithy_client28.serializeFloat)(entry);
      });
    }, "se_DoubleArray");
    var se_Field = /* @__PURE__ */ __name((input, context) => {
      return Field.visit(input, {
        ...
        doubleValue: /* @__PURE__ */ __name((value) => ({ doubleValue: (0, import_smithy_client28.serializeFloat)(value) }), "doubleValue"),
    ...
    var se_SqlParameter = /* @__PURE__ */ __name((input, context) => {
      return (0, import_smithy_client28.take)(input, {
        name: [],
        typeHint: [],
        value: /* @__PURE__ */ __name((_2) => se_Field(_2, context), "value")
      });
    }, "se_SqlParameter");
    ...
    var de_ArrayValue = /* @__PURE__ */ __name((output, context) => {
      ...
      if (output.booleanValues != null) {
        return {
          booleanValues: (0, import_smithy_client28._json)(output.booleanValues)
        };
      }
      ...
      if (output.longValues != null) {
        return {
          longValues: (0, import_smithy_client28._json)(output.longValues)
        };
      }
      if (output.stringValues != null) {
        return {
          stringValues: (0, import_smithy_client28._json)(output.stringValues)
        };
      }
    ...
    var de_Field = /* @__PURE__ */ __name((output, context) => {
      ...
      if ((0, import_smithy_client28.expectBoolean)(output.booleanValue) !== void 0) {
        return { booleanValue: (0, import_smithy_client28.expectBoolean)(output.booleanValue) };
      }
      if ((0, import_smithy_client28.limitedParseDouble)(output.doubleValue) !== void 0) {
        return { doubleValue: (0, import_smithy_client28.limitedParseDouble)(output.doubleValue) };
      }
      if ((0, import_smithy_client28.expectBoolean)(output.isNull) !== void 0) {
        return { isNull: (0, import_smithy_client28.expectBoolean)(output.isNull) };
      }
      if ((0, import_smithy_client28.expectLong)(output.longValue) !== void 0) {
        return { longValue: (0, import_smithy_client28.expectLong)(output.longValue) };
      }
      if ((0, import_smithy_client28.expectString)(output.stringValue) !== void 0) {
        return { stringValue: (0, import_smithy_client28.expectString)(output.stringValue) };
      }
      return { $unknown: Object.entries(output)[0] };
    }, "de_Field");
    ...
    var de__Record = /* @__PURE__ */ __name((output, context) => {
      return (0, import_smithy_client28.take)(output, {
        values: /* @__PURE__ */ __name((_2) => de_Row(_2, context), "values")
      });
    }, "de__Record");
    ...
    var de_ResultFrame = /* @__PURE__ */ __name((output, context) => {
      return (0, import_smithy_client28.take)(output, {
        records: /* @__PURE__ */ __name((_2) => de_Records(_2, context), "records"),
        resultSetMetadata: import_smithy_client28._json
      });
    }, "de_ResultFrame");
    ...
    var de_SqlStatementResult = /* @__PURE__ */ __name((output, context) => {
      return (0, import_smithy_client28.take)(output, {
        numberOfRecordsUpdated: import_smithy_client28.expectLong,
        resultFrame: /* @__PURE__ */ __name((_2) => de_ResultFrame(_2, context), "resultFrame")
      });
    ...
    var de_StructValue = /* @__PURE__ */ __name((output, context) => {
      return (0, import_smithy_client28.take)(output, {
        attributes: /* @__PURE__ */ __name((_2) => de_ArrayValueList(_2, context), "attributes")
      });
    }, "de_StructValue");
    ...
    var de_Value = /* @__PURE__ */ __name((output, context) => {
      ...
      if ((0, import_smithy_client28.expectLong)(output.bigIntValue) !== void 0) {
        return { bigIntValue: (0, import_smithy_client28.expectLong)(output.bigIntValue) };
      }
      if ((0, import_smithy_client28.expectBoolean)(output.bitValue) !== void 0) {
        return { bitValue: (0, import_smithy_client28.expectBoolean)(output.bitValue) };
      }
      if (output.blobValue != null) {
        return {
          blobValue: context.base64Decoder(output.blobValue)
      ...
      if ((0, import_smithy_client28.expectInt32)(output.intValue) !== void 0) {
        return { intValue: (0, import_smithy_client28.expectInt32)(output.intValue) };
      }
      if ((0, import_smithy_client28.expectBoolean)(output.isNull) !== void 0) {
        return { isNull: (0, import_smithy_client28.expectBoolean)(output.isNull) };
      }
      if ((0, import_smithy_client28.limitedParseFloat32)(output.realValue) !== void 0) {
        return { realValue: (0, import_smithy_client28.limitedParseFloat32)(output.realValue) };
      }
      if ((0, import_smithy_client28.expectString)(output.stringValue) !== void 0) {
        return { stringValue: (0, import_smithy_client28.expectString)(output.stringValue) };
      }
    ...
    var _a22;
    var BeginTransactionCommand = (_a22 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        (0, import_middleware_serde5.getSerdePlugin)(config, this.serialize, this.deserialize),
        (0, import_middleware_endpoint6.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var _a23;
    var CommitTransactionCommand = (_a23 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        (0, import_middleware_serde5.getSerdePlugin)(config, this.serialize, this.deserialize),
        (0, import_middleware_endpoint6.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var _a24;
    var ExecuteSqlCommand = (_a24 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        (0, import_middleware_serde5.getSerdePlugin)(config, this.serialize, this.deserialize),
        (0, import_middleware_endpoint6.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var _a26;
    var RollbackTransactionCommand = (_a26 = class extends import_smithy_client28.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o3) {
      return [
        (0, import_middleware_serde5.getSerdePlugin)(config, this.serialize, this.deserialize),
        (0, import_middleware_endpoint6.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
      ];
    ...
    var _a27;
    var RDSData = (_a27 = class extends RDSDataClient2 {
    }, __name(_a27, "RDSData"), _a27);
    (0, import_smithy_client28.createAggregatedClient)(commands3, RDSData);
  }
});
